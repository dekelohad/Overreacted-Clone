    ...
    <main className="main">
      <navbar>
        <div className="navbar-center">
          <h1 className="navbar-center__header">Overreacted</h1>
      ...
      <aside className="aside">
        <div className="aside_header">
          <img
            className="aside___img"
            alt="writerImage"
            src="https://avatars0.githubusercontent.com/u/23708468?s=460&u=3ff50a99ea0cbe48a43c49b82e02ec036848d58e&v=4"
          ></img>
          <p className="aside___Paragraph">
            Personal blog by <span className="aside__writer">Ohad Dekel</span>.
      ...
      <footer>
        <span>
          Clone Of Dan Abramov
          <a href="https://iqkui.com/" target="new_blank">
            Blog
          </a>
        </span>
      </footer>
